  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.props.article.articleBody === "No Article Found" ? (
          <Segment color="red" style={{ marginTop: "200px" }}>
            <ReactPlaceholder
            ...
            >
              <Header color="red" className="slide-in-fwd-top">
                <div>
                  <h2>Ahh...awkward!</h2>
                  <h3>Seems like, it's a BAD URL!</h3>
                  <img src={notFoundSvg} style={{ width: "20%" }} />
                  <h1>
                    Please navigate to{" "}
